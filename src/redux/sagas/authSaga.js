  ...
  switch (type) {
    ...
    case SIGNUP:
      try {
        ...
        const ref = yield call(firebase.createAccount, payload.email, payload.password, payload.fullname);
        console.log("SIGNUP INIT after result")
        ...
        // yield call(firebase.addUser, ...ref, user);
