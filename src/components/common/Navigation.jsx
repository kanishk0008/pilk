  ...
  return (
    <nav className="navigation" ref={navbar}>
      ...
      <ul className="navigation-menu-main">
        ...
        <li><NavLink activeClassName="navigation-menu-active" exact to={ROUTE.OUR_STORY}>Our Story</NavLink></li>
        <li><NavLink activeClassName="navigation-menu-active" exact to={ROUTE.FAQs}>FAQs</NavLink></li>
        ...
        {store.user ? (
          ...
          <li className="navigation-action">
            {pathname !== ROUTE.SIGNUP && (
              <Link
                className="button button-small margin-top-s"
                onClick={onClickLink}
                to={ROUTE.SIGNUP}
              >
                Sign Up
            ...
            {pathname !== ROUTE.SIGNIN && (
              <Link
                className="button button-small button-muted margin-left-s margin-top-s"
                onClick={onClickLink}
                to={ROUTE.SIGNIN}
              >
                Sign In
