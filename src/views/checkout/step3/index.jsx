...
import { displayActionMessage, shprktHttp } from "helpers/utils";
...
const Payment = ({ basket, shipping, payment, subtotal }) => {
  ...
  const onConfirm = () => {
    ...
    const url =
      "https://us-central1-" +
      projectId +
      ".cloudfunctions.net/rzp-create-order";
    ...
    if (bypasPayment) {
      ...
      order["fulfillment_date"] = new Intl.DateTimeFormat("en-IN", {
        year: "numeric",
        month: "2-digit",
        day: "2-digit",
        hour: "2-digit",
      ...
      if (prod.selectedSize == 24) {
        ...
        order2["fulfillment_date"] = new Intl.DateTimeFormat("en-IN", {
          year: "numeric",
          month: "2-digit",
          day: "2-digit",
          hour: "2-digit",
          minute: "2-digit",
          second: "2-digit",
        }).format(Date.now() + frtenDayInterval);
        ...
        order2["fulfillment_date"] = new Intl.DateTimeFormat("en-IN", {
          ...
          minute: "2-digit",
          second: "2-digit",
        }).format(Date.now() + tenDayInterval);
        order2["fulfillment_ts"] = Date.now() + tenDayInterval;
        dispatch(createOrder(order2));

        const order3 = Object.assign({}, order);
        order3["fulfillment_date"] = new Intl.DateTimeFormat("en-IN", {
          year: "numeric",
          month: "2-digit",
          day: "2-digit",
          hour: "2-digit",
          minute: "2-digit",
          second: "2-digit",
        }).format(Date.now() + twntDayInterval);
        ...
        order2["fulfillment_date"] = new Intl.DateTimeFormat("en-IN", {
          ...
          minute: "2-digit",
          second: "2-digit",
        }).format(Date.now() + sevenDayInterval);
        ...
        order4["fulfillment_date"] = new Intl.DateTimeFormat("en-IN", {
          year: "numeric",
          month: "2-digit",
          day: "2-digit",
          hour: "2-digit",
          minute: "2-digit",
          second: "2-digit",
        }).format(Date.now() + twnt1DayInterval);
        ...
        .then(function (data) {
          ...
          const options = {
            ...
            handler(response) {
              ...
              const { flat, area, city, state, pincode, email, mobile } =
                shipping;
              ...
              const shprkt_body = {
                ...
                billing_address_2: area,
                billing_city: city,
                billing_pincode: pincode,
                billing_state: state,
                billing_country: "India",
                billing_email: email,
                billing_phone: mobile.value.substring(2, 12),
              ...
              shprktHttp(
                ...
                .then((resp) =>
                  console.log("Request Success Shiprocket-->", resp.data)
                )
  ...
  const getEmailTemplate = (orderId) => {
    return (
      '<style type=text/css> @media screen { @font-face { font-family: "Source Sans Pro"; font-style: normal; font-weight: 400; src: local("Source Sans Pro Regular"), local("SourceSansPro-Regular"), url(https://fonts.gstatic.com/s/sourcesanspro/v10/ODelI1aHBYDBqgeIAH2zlBM0YzuT7MdOe03otPbuUS0.woff) format("woff");}' +
      ...
      "<tr>" +
      '<td align="center" valign="top" width="600">' +
      '<table border=0 cellpadding=0 cellspacing=0 width=100% style="max-width: 600px;" bgcolor=" #fff5c4"> <tr> <td align=center style="font-family: ' +
      "'Source Sans Pro'" +
      ' Helvetica, Arial, sans-serif; border-left: 3px solid #5780E5; border-right: 3px solid #5780E5;"> <img src=https://firebasestorage.googleapis.com/v0/b/pilk-1.appspot.com/o/order-confirmed.png?alt=media&amp;token=5ba06a7b-cca8-4322-9453-f88d64d37f25 alt=Pilk-confirmed border=0 style="display: block; max-width: 590px;"> </td> </tr> </table> ' +
      "</td>" +
      "</tr>" +
      "</table>" +
      "</td> </tr> <tr> <td align=center> " +
      ...
      "<tr>" +
      '<td align="center" valign="top" width="600">' +
      '<table border=0 cellpadding=0 cellspacing=0 width=100% style="max-width: 600px;" bgcolor=" #fff5c4"> <tr> <td align=left style="padding: 36px 24px 0; font-family: ' +
      " 'Source Sans Pro'" +
      ' Helvetica, Arial, sans-serif; border-left: 3px solid #5780E5; border-right: 3px solid #5780E5;"> <h1 style="margin: 0; font-size: 32px; font-weight: 700; letter-spacing: -1px; line-height: 48px;">Thank you for your order!</h1> </td> </tr> </table> ' +
      "</td>" +
      "</tr>" +
      "</table>" +
      "</td> </tr>  <tr> <td align=center> " +
      ...
      "<tr>" +
      '<td align="center" valign="top" width="600">' +
      ' <table border=0 cellpadding=0 cellspacing=0 width=100% style="max-width: 600px;" bgcolor=" #fff5c4"><tr> <td align=left style="padding: 24px; font-family: ' +
      "'Source Sans Pro'" +
      ', Helvetica, Arial, sans-serif; font-size: 16px; line-height: 24px; border-left: 3px solid #5780E5; border-right: 3px solid #5780E5;"> <p style="margin: 0;">Your order will be delivered within 3-4 days. Here is a summary of your recent order. If you have any questions or concerns about your order, please reply.</p> </td> </tr>  <tr> <td align=left style="padding: 24px; font-family: ' +
      "'Source Sans Pro'" +
      ', Helvetica, Arial, sans-serif; font-size: 16px; line-height: 24px; border-left: 3px solid #5780E5; border-right: 3px solid #5780E5;"> <table border=0 cellpadding=0 cellspacing=0 width=100%> <tr> <td align=left bgcolor=#5780E5 width=75% style="padding: 12px;font-family: ' +
      "'Source Sans Pro'" +
      ', Helvetica, Arial, sans-serif; font-size: 16px; line-height: 24px;"><strong>Order Id</strong></td> <td align=left bgcolor=#5780E5 width=25% style="padding: 12px;font-family: ' +
      "'Source Sans Pro'" +
      ', Helvetica, Arial, sans-serif; font-size: 16px; line-height: 24px;"><strong>' +
      orderId +
      '</strong></td> </tr> <tr> <td align=left width=75% style="padding: 6px 12px;font-family: ' +
      "'Source Sans Pro'" +
      ', Helvetica, Arial, sans-serif; font-size: 16px; line-height: 24px;">' +
      "Pilk Original - " +
      prod.selectedSize +
      " bottles" +
      '</td> <td align=left width=25% style="padding: 6px 12px;font-family: ' +
      "'Source Sans Pro'" +
      ', Helvetica, Arial, sans-serif; font-size: 16px; line-height: 24px;"> ' +
      displayMoney(subtotal) +
      '</td> </tr> <tr> <td align=left width=75% style="padding: 6px 12px;font-family: ' +
      "'Source Sans Pro'" +
      ', Helvetica, Arial, sans-serif; font-size: 16px; line-height: 24px;">Shipping</td> <td align=left width=25% style="padding: 6px 12px;font-family: ' +
      "'Source Sans Pro'" +
      ', Helvetica, Arial, sans-serif; font-size: 16px; line-height: 24px;">0.00</td> </tr> <tr> <td align=left width=75% style="padding: 12px; font-family: ' +
      "'Source Sans Pro'" +
      ', Helvetica, Arial, sans-serif; font-size: 16px; line-height: 24px; border-top: 2px dashed #D2C7BA; border-bottom: 2px dashed #D2C7BA;"><strong>Total</strong></td> <td align=left width=25% style="padding: 12px; font-family: ' +
      "'Source Sans Pro'" +
      ', Helvetica, Arial, sans-serif; font-size: 16px; line-height: 24px; border-top: 2px dashed #D2C7BA; border-bottom: 2px dashed #D2C7BA;"><strong>' +
      displayMoney(subtotal) +
      ...
      '<div style="display: inline-block; width: 100%; max-width: 50%; min-width: 240px; vertical-align: top;"> <table align=left border=0 cellpadding=0 cellspacing=0 width=100% style="max-width: 300px;"> <tr> <td align=left valign=top style="padding-bottom: 36px; padding-left: 36px; font-family: ' +
      "'Source Sans Pro'" +
      ', Helvetica, Arial, sans-serif; font-size: 16px; line-height: 24px;"> <p><strong>Delivery Address</strong></p> <p>' +
      shipping.flat +
      ", " +
      shipping.area +
      ",<br/> " +
      ...
      '"<div style="display: inline-block; width: 100%; max-width: 50%; min-width: 240px; vertical-align: top;"> <table align=left border=0 cellpadding=0 cellspacing=0 width=100% style="max-width: 300px;"> <tr> <td align=left valign=top style="padding-bottom: 36px; padding-left: 36px; font-family: ' +
      "'Source Sans Pro'" +
      ', Helvetica, Arial, sans-serif; font-size: 16px; line-height: 24px;"> <p><strong>Billing Address</strong></p> <p>' +
      shipping.flat +
      ", " +
      shipping.area +
      ",<br/> " +
      ...
      "<tr>" +
      '<td align="center" valign="top" width="600">' +
      '<table border=0 cellpadding=0 cellspacing=0 width=100% style="max-width: 600px;"> <tr> <td align=center style="padding: 12px 24px; font-family: ' +
      " 'Source Sans Pro'" +
      ', Helvetica, Arial, sans-serif; font-size: 14px; line-height: 20px; color: #666;"> <p style="margin: 0;">You received this email because we received an order from your account. If you didn not order you can safely delete this email.</p> </td> </tr> ' +
      '<tr> <td align=center style="padding: 12px 24px; font-family: ' +
      "'Source Sans Pro'" +
      ', Helvetica, Arial, sans-serif; font-size: 14px; line-height: 20px; color: #666;"> <a href=https://www.pilk.in>www.pilk.in</a> </td> </tr>  </table> ' +
